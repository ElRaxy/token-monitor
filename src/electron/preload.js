...
contextBridge.exposeInMainWorld('tokenMonitor', {
  ...
  getCodexBarSummaryStatus: () => ipcRenderer.invoke('codexbarSummary:status'),
  copyCodexBarSummaryToken: () => ipcRenderer.invoke('codexbarSummary:copyToken'),
  regenerateCodexBarSummaryToken: () => ipcRenderer.invoke('codexbarSummary:regenerateToken'),
